...
sudo apt --yes --allow-unauthenticated install  gcc
sudo apt --yes --allow-unauthenticated install  clangd
sudo apt --yes --allow-unauthenticated install  g++
...
sudo apt --yes --allow-unauthenticated install  build-essential # Used for make
sudo apt --yes --allow-unauthenticated install  make
...
sudo apt --yes --allow-unauthenticated install  okular
sudo apt --yes --allow-unauthenticated install  unoconv
sudo apt --yes --allow-unauthenticated install  net-tools
sudo apt --yes --allow-unauthenticated install  tree
sudo apt --yes --allow-unauthenticated install  mlocate
sudo apt --yes --allow-unauthenticated install  traceroute
sudo apt --yes --allow-unauthenticated install  xclip
sudo apt --yes --allow-unauthenticated install  terminator
sudo apt --yes --allow-unauthenticated install  cmatrix
